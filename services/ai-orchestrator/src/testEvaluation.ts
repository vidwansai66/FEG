...
async function runEval() {
  ...
  function assertState(name: string, actual: string, expected: string) {
    if (actual === expected) {
  ...
  const req2: UserIntent = { action: "build_draft_slip", legs: [{ eventQuery: "Arzenal", marketQuery: "Match Result", selectionQuery: "Arsenal" }] };
  ...
  const req3: UserIntent = { action: "build_draft_slip", legs: [{ eventQuery: "Arsenal", marketQuery: "Match Result", selectionQuery: "Chelski" }] };
  ...
  const req4: UserIntent = { action: "build_draft_slip", legs: [{ eventQuery: "Manchester", marketQuery: "Match Result", selectionQuery: "Man City" }] };
  ...
  const req5: UserIntent = { action: "build_draft_slip", legs: [{ eventQuery: "Arsenal", marketQuery: "Match Result", selectionQuery: "Saka" }] };
  ...
  const req6: UserIntent = { action: "build_draft_slip", legs: [{ eventQuery: "Real Madrid", marketQuery: "Over 2.5 goals", selectionQuery: "Over 2.5" }] };
  ...
  const req10: UserIntent = { action: "build_draft_slip", legs: [{ eventQuery: "Arsenal", marketQuery: "Match Result", selectionQuery: "Arsenal" }] };
  ...
  // 11. Tool timeout
  const req11: UserIntent = { action: "build_draft_slip", legs: [{ eventQuery: "timeout_event", marketQuery: "Match Result", selectionQuery: "Arsenal" }] };
  const res11 = await processUserMessage("sid-11", "", req11);
  assertState("11. Tool timeout", res11.status, "TOOL_ERROR");

  // 12. Tool failure
  const req12: UserIntent = { action: "build_draft_slip", legs: [{ eventQuery: "Arsenal", marketQuery: "error_market", selectionQuery: "Arsenal" }] };
  ...
  const req13: UserIntent = { action: "build_draft_slip", legs: [{ eventQuery: "Arsenal", marketQuery: "Match Result", selectionQuery: "London" }] };
