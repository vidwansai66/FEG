...
describe("sportsClient", () => {
    ...
    it("searchEvents calls correct URL and formats response", async () => {
        ...
        expect(fetchMock).toHaveBeenCalledWith(expect.stringContaining("/api/sports/events?query=arsenal"), expect.any(Object));
    ...
    it("searchMarkets calls correct URL and formats response", async () => {
        ...
        expect(fetchMock).toHaveBeenCalledWith(expect.stringContaining("/api/sports/events/evt_123/markets?query=match"), expect.any(Object));
    ...
    it("resolveSelection calls correct URL", async () => {
        ...
        expect(fetchMock).toHaveBeenCalledWith(expect.stringContaining("/api/sports/events/evt_123/markets/mkt_123/selections?query=arsenal"), expect.any(Object));
    ...
    it("getCurrentOdds calls correct URL and returns odds", async () => {
        ...
        expect(fetchMock).toHaveBeenCalledWith(expect.stringContaining("/api/sports/odds"), expect.objectContaining({
            method: "POST",
...
//# sourceMappingURL=sportsClient.test.js.map