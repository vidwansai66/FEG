...
export const searchEvents = async (input: z.infer<typeof SearchEventsTool.inputSchema>) => {
...
export const searchMarkets = async (input: z.infer<typeof SearchMarketsTool.inputSchema>) => {
...
export const resolveSelection = async (input: z.infer<typeof ResolveSelectionTool.inputSchema> & { eventId?: string }) => {
...
export const getCurrentOdds = async (input: z.infer<typeof GetCurrentOddsTool.inputSchema>) => {
